...
if (Config.WORKTYPE == 'private') {
  ...
  var topText, bottomText;
    ...
    Asena.addCommand({pattern: 'coffeecup ?(.*)', fromMe: true, desc: Lang.COFFEECUP_DESC}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    Asena.addCommand({pattern: 'coffeecup ?(.*)', fromMe: false, desc: Lang.COFFEECUP_DESC}, (async (message, match) => {
